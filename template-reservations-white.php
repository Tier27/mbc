...
<br>
  <div class="full-container" style="margin: 0px 25px;">
    ...
    <div class="row">
      <div class="col-sm-12">
        <h3>Reservation Toolbar <small>instruction space</small></h3>
        <div class="well well-plain">
	      <button class="btn btn-default" id="todays-date">Today</button>
    	      <span class="glyphicon glyphicon-chevron-left"></span>
              <input class="form-styling" id="reportrange" class="" value="<?php echo date('m/d/Y'); ?>" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
    	      <span class="glyphicon glyphicon-chevron-right"></span>
              <input class="form-styling" id="search" class="" placeholder="Search..." style="background: #fff; padding: 5px 10px; border: 1px solid #ccc">
              ...
              <textarea class="form-styling" id="day-notes" class="" style="background: #fff; padding: 5px 10px; border: 1px solid #ccc"><?php echo $date->notes; ?></textarea>
...
-->
        <div class="" id="reservation-target">
         
          <form class="form-horizontal">
            <fieldset>
               <h3>Make a Reservation <small>instructions rock.</small></h3>
              <div class="control-group">
                <div class="reservation-section">
                <label class="control-label" for="reservationtime">Reservation Date:</label>
                <div class="controls">
                  <div class="input-prepend">
                    <input class="form-control" type="text" style="width: 300px" name="date" id="date" value="<?php echo date('m/d/Y'); ?>"  class="span4"/>
                  </div>
                </div>
              </div>
            </div>
		...
		<br>
                ...
                <button type="submit" class="submit btn btn-success" id="cnb">Create New Booking</button>
              </form>
