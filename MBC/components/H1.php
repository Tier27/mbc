    ...
    <script>
	function TSI($obj, $index, $path) { var AI = parseInt($obj.src.substr($obj.src.length-5)); if (AI == $index) { NI = AI + 3; $obj.src=$path+"/SMI-"+NI+".png"; } else { $obj.src=$path+"/SMI-"+$index+".png"; } }
    </script>
	<div id="newid"></div>
        <div id="social-media">
            <ul>
		...
		echo "<li><a href=".$links[$i-1]."><img src='img/SMI-$i.png' onmouseover='TSI(this, $i,\"img\");'></a></li>"; } ?>
            </ul>
        </div>
