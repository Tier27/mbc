...
function cycle() { if (imgCounter==count) { return; }
		   var contentURL = "<?php echo get_template_directory_uri()."/"; ?>";
		   imgCounter++;
...
<img id="background" src="<?php echo get_template_directory_uri(); ?>/imagene/uploads/<?php echo $src; ?>" style="display:block; position: absolute; width: 100%; height: 100%; "> 
