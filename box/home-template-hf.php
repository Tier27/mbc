...
<div id="header">
	...
	<style> <?php echo '#header-nav a#'.$pagename.'-hn'; ?> { color: #b5121b; } </style>
		...
		<a id="nav-tri-<?php echo $page; ?>" href="<?php echo $page; ?>.php"><img src="<?php echo get_template_directory_uri(); ?>/MBC/img/lane-arrow.png"></a>
		<li><a class="header-link" id="<?php echo $page; ?>-hn" href="<?php echo $page; ?>.php"><?php echo $title; ?></a></li>
		<?php } ?>
        </ul>
    </div>
    <div id="header-logo">
        <a href="index.php"><img src="<?php echo get_template_directory_uri(); ?>/MBC/imagene/uploads/<?php echo get_image_name('logo'); ?>"></a>
    </div>
