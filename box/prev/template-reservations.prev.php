<?php /* Template Name: Reservations Prev */ ?>
<!DOCTYPE html>
...
<head>
  ...
  <link type='text/css' rel="stylesheet" href="http://development.tier27.com/Mission/wp-content/plugins/reservations/assets/reservations.css?ver=1.01";
      ...
      <div class="modal-body">
		...
		<div class="dropdown">
		  ...
		  <?php } ?>
                ...
                <div class="inline">  
                <div class="controls">
                  <input type="text" class="input-sm" id="manage-reservation-hours" name="hours" data-original-title="Bowlers">
                </div>  
                </div>
                <div class="inline">
                  <input type="checkbox"> *Late Start
